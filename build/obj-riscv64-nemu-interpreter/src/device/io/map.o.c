...
# 5 "src/device/io/map.c" 2



static uint8_t io_space[(5 * 1024 * 1024)] __attribute((aligned(4096))) = {};
...
# 16 "src/device/io/map.c" 3 4
 ((void) sizeof ((
# 16 "src/device/io/map.c"
 p_space - io_space < (5 * 1024 * 1024)
# 16 "src/device/io/map.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 16 "src/device/io/map.c"
 p_space - io_space < (5 * 1024 * 1024)
...
# 16 "src/device/io/map.c" 3 4
 , "src/device/io/map.c", 16, __extension__ __PRETTY_FUNCTION__); }))
# 16 "src/device/io/map.c"
                                          ;
  return p;
}
...
static inline void check_bound(IOMap *map, paddr_t addr) {
  do { if (!(map != 
# 21 "src/device/io/map.c" 3 4
 ((void *)0) 
# 21 "src/device/io/map.c"
 && addr <= map->high && addr >= map->low)) { fflush(
# 21 "src/device/io/map.c" 3 4
 stdout
# 21 "src/device/io/map.c"
 ); fprintf(
...
# 21 "src/device/io/map.c" 3 4
 stderr
# 21 "src/device/io/map.c"
 , "address (" "0x%08x" ") is out of bound {%s} [" "0x%08x" ", " "0x%08x" "] at pc = " "0x%016lx", addr, (map ? map->name : "???"), (map ? map->low : 0), (map ? map->high : 0), cpu.pc); fprintf(
# 21 "src/device/io/map.c" 3 4
 stderr
# 21 "src/device/io/map.c"
...
# 21 "src/device/io/map.c"
 "map != ((void *)0) && addr <= map->high && addr >= map->low"
# 21 "src/device/io/map.c" 3 4
 ,
...
static inline void invoke_callback(io_callback_t c, paddr_t offset, int len, 
# 26 "src/device/io/map.c" 3 4
                                                                            _Bool 
# 26 "src/device/io/map.c"
                                                                                 is_write) {
  if (c != 
# 27 "src/device/io/map.c" 3 4
          ((void *)0)
# 27 "src/device/io/map.c"
...
# 34 "src/device/io/map.c" 3 4
                                             0
# 34 "src/device/io/map.c"
                                                  );
...
# 39 "src/device/io/map.c"
  ...
  invoke_callback(map->callback, offset, len, 
# 43 "src/device/io/map.c" 3 4
                                             1
# 43 "src/device/io/map.c"
                                                 );
}

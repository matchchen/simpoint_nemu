...
void init_isa() {
  ...
  cpu.pc = (0x800a0000 + 0x0);
  do { printf("\33[1;34m[%s:%d,%s] " "lico2 will start from pc 0x%lx" "\33[0m\n", "src/isa/riscv64/init.c", 23, __func__, cpu.pc); ; } while (0);
  ...
  misa->extensions = (1 << (('i') - 'a')) | (1 << (('m') - 'a')) | (1 << (('a') - 'a')) | (1 << (('c') - 'a')) | (1 << (('s') - 'a')) | (1 << (('u') - 'a'));
  misa->extensions |= (1 << (('d') - 'a')) | (1 << (('f') - 'a'));
  misa->mxl = 2;
# 59 "src/isa/riscv64/init.c"
  extern char *cpt_file;
  extern 
# 60 "src/isa/riscv64/init.c" 3 4
        _Bool 
# 60 "src/isa/riscv64/init.c"
             checkpoint_restoring;
  if (cpt_file == 
# 61 "src/isa/riscv64/init.c" 3 4
                 ((void *)0) 
# 61 "src/isa/riscv64/init.c"
                      && !checkpoint_restoring) {
    memcpy(guest_to_host((0x800a0000 + 0x0)), img, sizeof(img));
  }
  ...
  do { printf("\33[1;34m[%s:%d,%s] " "NEMU will start from pc 0x%lx" "\33[0m\n", "src/isa/riscv64/init.c", 75, __func__, cpu.pc); ; } while (0);

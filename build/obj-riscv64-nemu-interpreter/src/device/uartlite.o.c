...
# 3 "src/device/uartlite.c" 2
# 20 "src/device/uartlite.c"
static uint8_t *serial_base = 
# 20 "src/device/uartlite.c" 3 4
                             ((void *)0)
# 20 "src/device/uartlite.c"
                                 ;
# 109 "src/device/uartlite.c"
static void serial_io_handler(uint32_t offset, int len, 
# 109 "src/device/uartlite.c" 3 4
                                                       _Bool 
# 109 "src/device/uartlite.c"
                                                            is_write) {
  ...
  switch (offset) {
    ...
    case 0x0:
      if (is_write) 
# 118 "src/device/uartlite.c" 3 4
                   _IO_putc (
# 118 "src/device/uartlite.c"
                   serial_base[0x0]
# 118 "src/device/uartlite.c" 3 4
                   , stderr)
# 118 "src/device/uartlite.c"
...
# 119 "src/device/uartlite.c" 3 4
          stdout
# 119 "src/device/uartlite.c"
          ); fprintf(
# 119 "src/device/uartlite.c" 3 4
          stderr
# 119 "src/device/uartlite.c"
...
# 119 "src/device/uartlite.c" 3 4
          stderr
# 119 "src/device/uartlite.c"
          , "Cannot read UARTLITE_TX_FIFO"); fprintf(
# 119 "src/device/uartlite.c" 3 4
          stderr
# 119 "src/device/uartlite.c"
...
# 119 "src/device/uartlite.c"
          "0"
# 119 "src/device/uartlite.c" 3 4
          , "src/device/uartlite.c", 119, __extension__ __PRETTY_FUNCTION__); }))
# 119 "src/device/uartlite.c"
          ; } } while (0);
      break;
    case 0x8:
      if (!is_write) serial_base[0x8] = 0x0;
      break;
  }
}
...
void init_uartlite() {
  ...
  add_pio_map("uartlite", 0x3f8, serial_base, 0xd, serial_io_handler);
  add_mmio_map("uartlite", 0x20100000, serial_base, 0xd, serial_io_handler);

...
static inline IOMap* fetch_mmio_map(paddr_t addr) {
  ...
  return (mapid == -1 ? 
# 10 "src/device/io/mmio.c" 3 4
                       ((void *)0) 
# 10 "src/device/io/mmio.c"
                            : &maps[mapid]);
}
...
# 15 "src/device/io/mmio.c" 3 4
 ((void) sizeof ((
# 15 "src/device/io/mmio.c"
 nr_map < 16
# 15 "src/device/io/mmio.c" 3 4
...
# 15 "src/device/io/mmio.c"
 "nr_map < NR_MAP"
# 15 "src/device/io/mmio.c" 3 4
 , "src/device/io/mmio.c", 15, __extension__ __PRETTY_FUNCTION__); }))
# 15 "src/device/io/mmio.c"
                        ;
  maps[nr_map] = (IOMap){ .name = name, .low = addr, .high = addr + len - 1,
    .space = space, .callback = callback };
  do { printf("\33[1;34m[%s:%d,%s] " "Add mmio map '%s' at [" "0x%08x" ", " "0x%08x" "]" "\33[0m\n", "src/device/io/mmio.c", 19, __func__, maps[nr_map].name, maps[nr_map].low, maps[nr_map].high); ; } while (0)
                                                             ;
  fflush(
# 20 "src/device/io/mmio.c" 3 4
        stdout
# 20 "src/device/io/mmio.c"
              );

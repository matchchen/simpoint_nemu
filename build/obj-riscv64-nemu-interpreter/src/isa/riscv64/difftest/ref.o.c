# 1 "src/isa/riscv64/difftest/ref.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "src/isa/riscv64/difftest/ref.c" 2
...
# 3 "src/isa/riscv64/difftest/ref.c" 2
...
# 4 "src/isa/riscv64/difftest/ref.c" 2
# 1 "src/isa/riscv64/difftest/../local-include/intr.h" 1
...
# 5 "src/isa/riscv64/difftest/../local-include/intr.h" 2
...
# 31 "src/isa/riscv64/difftest/../local-include/intr.h" 3 4
_Bool 
# 31 "src/isa/riscv64/difftest/../local-include/intr.h"
    intr_deleg_S(word_t exceptionNO);
# 5 "src/isa/riscv64/difftest/ref.c" 2
# 1 "src/isa/riscv64/difftest/../local-include/csr.h" 1
# 73 "src/isa/riscv64/difftest/../local-include/csr.h"
...
# 203 "src/isa/riscv64/difftest/../local-include/csr.h"
typedef union { struct {
...
# 316 "src/isa/riscv64/difftest/../local-include/csr.h"
typedef union { struct {
  uint64_t ppn :44;
  uint64_t asid:16;
  uint64_t mode: 4;
...
# 418 "src/isa/riscv64/difftest/../local-include/csr.h"
...
word_t pmp_tor_mask();
# 6 "src/isa/riscv64/difftest/ref.c" 2
...
void isa_difftest_regcpy(void *dut, 
# 67 "src/isa/riscv64/difftest/ref.c" 3 4
                                   _Bool 
# 67 "src/isa/riscv64/difftest/ref.c"
                                        direction) {
  if (direction == DIFFTEST_TO_REF) {
    memcpy(&cpu, dut, (sizeof(uint64_t) * (32 + 32 + 1 + 6 + 11 + 1)));
    csr_writeback();
  } else {
    csr_prepare();
    memcpy(dut, &cpu, (sizeof(uint64_t) * (32 + 32 + 1 + 6 + 11 + 1)));
  }
}

void isa_difftest_csrcpy(void *dut, 
# 77 "src/isa/riscv64/difftest/ref.c" 3 4
                                   _Bool 
# 77 "src/isa/riscv64/difftest/ref.c"
                                        direction) {
  if (direction == DIFFTEST_TO_REF) {
...
void isa_difftest_uarchstatus_cpy(void *dut, 
# 85 "src/isa/riscv64/difftest/ref.c" 3 4
                                            _Bool 
# 85 "src/isa/riscv64/difftest/ref.c"
                                                 direction) {
  if (direction == DIFFTEST_TO_REF) {

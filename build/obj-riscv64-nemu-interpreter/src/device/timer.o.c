...
# 3 "src/device/timer.c" 2


static uint32_t *rtc_port_base = 
# 5 "src/device/timer.c" 3 4
                                ((void *)0)
# 5 "src/device/timer.c"
                                    ;

static void rtc_io_handler(uint32_t offset, int len, 
# 7 "src/device/timer.c" 3 4
                                                    _Bool 
# 7 "src/device/timer.c"
                                                         is_write) {
  
# 8 "src/device/timer.c" 3 4
 ((void) sizeof ((
# 8 "src/device/timer.c"
 offset == 0 || offset == 4
# 8 "src/device/timer.c" 3 4
...
# 8 "src/device/timer.c"
 "offset == 0 || offset == 4"
# 8 "src/device/timer.c" 3 4
 , "src/device/timer.c", 8, __extension__ __PRETTY_FUNCTION__); }))
# 8 "src/device/timer.c"
                                   ;
...
void init_timer() {
  ...
  add_pio_map ("rtc", 0x48, rtc_port_base, 8, rtc_io_handler);

...
# 5 "src/cpu/difftest/ref.c" 2

extern void init_flash();
# 34 "src/cpu/difftest/ref.c"
void difftest_memcpy(paddr_t nemu_addr, void *dut_buf, size_t n, 
# 34 "src/cpu/difftest/ref.c" 3 4
                                                                _Bool 
# 34 "src/cpu/difftest/ref.c"
                                                                     direction) {
...
# 52 "src/cpu/difftest/ref.c" 3 4
                               _Bool 
# 52 "src/cpu/difftest/ref.c"
                                    direction) {
  isa_difftest_regcpy(dut, direction);
}


void difftest_csrcpy(void *dut, 
# 57 "src/cpu/difftest/ref.c" 3 4
                               _Bool 
# 57 "src/cpu/difftest/ref.c"
                                    direction) {
  isa_difftest_csrcpy(dut, direction);
}

void difftest_uarchstatus_cpy(void *dut, 
# 61 "src/cpu/difftest/ref.c" 3 4
                                        _Bool 
# 61 "src/cpu/difftest/ref.c"
                                             direction) {

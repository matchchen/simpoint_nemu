...
# 8 "src/cpu/difftest/dut.c" 2

void (*ref_difftest_memcpy)(paddr_t addr, void *buf, size_t n, 
# 9 "src/cpu/difftest/dut.c" 3 4
                                                              _Bool 
# 9 "src/cpu/difftest/dut.c"
                                                                   direction) = 
# 9 "src/cpu/difftest/dut.c" 3 4
                                                                                ((void *)0)
# 9 "src/cpu/difftest/dut.c"
                                                                                    ;
void (*ref_difftest_regcpy)(void *dut, 
# 10 "src/cpu/difftest/dut.c" 3 4
                                      _Bool 
# 10 "src/cpu/difftest/dut.c"
                                           direction) = 
# 10 "src/cpu/difftest/dut.c" 3 4
                                                        ((void *)0)
# 10 "src/cpu/difftest/dut.c"
...
# 11 "src/cpu/difftest/dut.c" 3 4
                                       ((void *)0)
# 11 "src/cpu/difftest/dut.c"
                                           ;
void (*ref_difftest_raise_intr)(uint64_t NO) = 
# 12 "src/cpu/difftest/dut.c" 3 4
                                              ((void *)0)
# 12 "src/cpu/difftest/dut.c"
                                                  ;
# 160 "src/cpu/difftest/dut.c"

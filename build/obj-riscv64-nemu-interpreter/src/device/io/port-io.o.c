...
# 11 "src/device/io/port-io.c" 3 4
 ((void) sizeof ((
# 11 "src/device/io/port-io.c"
 nr_map < 16
# 11 "src/device/io/port-io.c" 3 4
...
# 11 "src/device/io/port-io.c"
 "nr_map < NR_MAP"
# 11 "src/device/io/port-io.c" 3 4
 , "src/device/io/port-io.c", 11, __extension__ __PRETTY_FUNCTION__); }))
# 11 "src/device/io/port-io.c"
                        ;
  
# 12 "src/device/io/port-io.c" 3 4
 ((void) sizeof ((
# 12 "src/device/io/port-io.c"
 addr + len <= 65535
# 12 "src/device/io/port-io.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 12 "src/device/io/port-io.c"
...
# 12 "src/device/io/port-io.c" 3 4
 , "src/device/io/port-io.c", 12, __extension__ __PRETTY_FUNCTION__); }))
# 12 "src/device/io/port-io.c"
                                        ;
  maps[nr_map] = (IOMap){ .name = name, .low = addr, .high = addr + len - 1,
    .space = space, .callback = callback };
  do { printf("\33[1;34m[%s:%d,%s] " "Add port-io map '%s' at [" "0x%08x" ", " "0x%08x" "]" "\33[0m\n", "src/device/io/port-io.c", 16, __func__, maps[nr_map].name, maps[nr_map].low, maps[nr_map].high); ; } while (0)
                                                             ;
...
# 23 "src/device/io/port-io.c" 3 4
 ((void) sizeof ((
# 23 "src/device/io/port-io.c"
 addr + len - 1 < 65535
# 23 "src/device/io/port-io.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 23 "src/device/io/port-io.c"
...
# 23 "src/device/io/port-io.c" 3 4
 , "src/device/io/port-io.c", 23, __extension__ __PRETTY_FUNCTION__); }))
# 23 "src/device/io/port-io.c"
                                           ;
...
# 34 "src/device/io/port-io.c" 3 4
 ((void) sizeof ((
# 34 "src/device/io/port-io.c"
 addr + len - 1 < 65535
# 34 "src/device/io/port-io.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 34 "src/device/io/port-io.c"
...
# 34 "src/device/io/port-io.c"
 "addr + len - 1 < PORT_IO_SPACE_MAX"
# 34 "src/device/io/port-io.c" 3 4
 , "src/device/io/port-io.c", 34, __extension__ __PRETTY_FUNCTION__); }))
# 34 "src/device/io/port-io.c"
                                           ;
  int mapid = find_mapid_by_addr(maps, nr_map, addr);

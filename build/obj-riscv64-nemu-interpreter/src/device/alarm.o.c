...
# 2 "src/device/alarm.c" 2
# 1 "/home/user/ecpt/work/simpoint_nemu/include/device/alarm.h" 1




# 4 "/home/user/ecpt/work/simpoint_nemu/include/device/alarm.h"
typedef void (*alarm_handler_t) ();
void add_alarm_handle(alarm_handler_t h);
# 3 "src/device/alarm.c" 2
...
# 5 "src/device/alarm.c" 2





# 9 "src/device/alarm.c"
static alarm_handler_t handler[8] = {};
static int idx = 0;

void add_alarm_handle(alarm_handler_t h) {
  
# 13 "src/device/alarm.c" 3 4
 ((void) sizeof ((
# 13 "src/device/alarm.c"
 idx < 8
# 13 "src/device/alarm.c" 3 4
...
# 13 "src/device/alarm.c"
 "idx < MAX_HANDLER"
# 13 "src/device/alarm.c" 3 4
 , "src/device/alarm.c", 13, __extension__ __PRETTY_FUNCTION__); }))
# 13 "src/device/alarm.c"
                          ;
  handler[idx ++] = h;
}
...
void init_alarm() {
  ...
  memset(&s, 0, sizeof(s));
  s.
# 27 "src/device/alarm.c" 3 4
   __sigaction_handler.sa_handler 
# 27 "src/device/alarm.c"
              = alarm_sig_handler;
  int ret = sigaction(
# 28 "src/device/alarm.c" 3 4
                     26
# 28 "src/device/alarm.c"
                              , &s, 
# 28 "src/device/alarm.c" 3 4
                                    ((void *)0)
# 28 "src/device/alarm.c"
  ...
  do { if (!(ret == 0)) { fflush(
# 29 "src/device/alarm.c" 3 4
 stdout
# 29 "src/device/alarm.c"
 ); fprintf(
# 29 "src/device/alarm.c" 3 4
 stderr
# 29 "src/device/alarm.c"
...
# 29 "src/device/alarm.c" 3 4
 stderr
# 29 "src/device/alarm.c"
 , "Can not set signal handler"); fprintf(
# 29 "src/device/alarm.c" 3 4
 stderr
# 29 "src/device/alarm.c"
...
# 29 "src/device/alarm.c"
 "ret == 0"
# 29 "src/device/alarm.c" 3 4
 , "src/device/alarm.c", 29, __extension__ __PRETTY_FUNCTION__); }))
# 29 "src/device/alarm.c"
 ; } } while (0);
  ...
  ret = setitimer(
# 35 "src/device/alarm.c" 3 4
                 ITIMER_VIRTUAL
# 35 "src/device/alarm.c"
                               , &it, 
# 35 "src/device/alarm.c" 3 4
                                      ((void *)0)
# 35 "src/device/alarm.c"
  ...
  do { if (!(ret == 0)) { fflush(
# 36 "src/device/alarm.c" 3 4
 stdout
# 36 "src/device/alarm.c"
 ); fprintf(
# 36 "src/device/alarm.c" 3 4
 stderr
# 36 "src/device/alarm.c"
...
# 36 "src/device/alarm.c"
 "ret == 0"
# 36 "src/device/alarm.c" 3 4
 , "src/device/alarm.c", 36, __extension__ __PRETTY_FUNCTION__); }))
# 36 "src/device/alarm.c"
 ; } } while (0);
}

# 1 "src/isa/riscv64/instr/priv/system.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "src/isa/riscv64/instr/priv/system.c" 2
...
# 3 "src/isa/riscv64/instr/priv/system.c" 2
...
# 4 "src/isa/riscv64/instr/priv/system.c" 2
...
int rtl_sys_slow_path(Decode *s, rtlreg_t *dest, const rtlreg_t *src1, uint32_t id, rtlreg_t *jpc) {
  ...
  if (funct3 == 0) {
    ...
    if (id == 0) {
      ...
      rtl_mv(s, jpc, (&tmp_reg[3]));
    } else {
      rtl_hostcall(s, HOSTCALL_PRIV, jpc, src1, 
# 15 "src/isa/riscv64/instr/priv/system.c" 3 4
                                               ((void *)0)
# 15 "src/isa/riscv64/instr/priv/system.c"
                                                   , id);
    }
  ...
  rtl_hostcall(s, HOSTCALL_CSR, (&tmp_reg[0]), 
# 29 "src/isa/riscv64/instr/priv/system.c" 3 4
                                   ((void *)0)
# 29 "src/isa/riscv64/instr/priv/system.c"
                                       , 
# 29 "src/isa/riscv64/instr/priv/system.c" 3 4
                                         ((void *)0)
# 29 "src/isa/riscv64/instr/priv/system.c"
  ...
  int imm = funct3 & 0x4;
  int op = funct3 & 0x3;
  if (imm) rtl_li(s, (&tmp_reg[1]), s->isa.instr.i.rs1);
  else rtl_mv(s, (&tmp_reg[1]), src1);
  switch (op) {
    case 2: rtl_or(s, (&tmp_reg[1]), (&tmp_reg[0]), (&tmp_reg[1])); break;
    case 3: rtl_not(s, (&tmp_reg[1]), (&tmp_reg[1])); rtl_and(s, (&tmp_reg[1]), (&tmp_reg[0]), (&tmp_reg[1])); break;
  }
  rtl_hostcall(s, HOSTCALL_CSR, 
# 38 "src/isa/riscv64/instr/priv/system.c" 3 4
                               ((void *)0)
# 38 "src/isa/riscv64/instr/priv/system.c"
                                   , (&tmp_reg[1]), 
# 38 "src/isa/riscv64/instr/priv/system.c" 3 4
                                         ((void *)0)
# 38 "src/isa/riscv64/instr/priv/system.c"

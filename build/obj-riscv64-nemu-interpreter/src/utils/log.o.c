...
void init_log(const char *log_file) {
  if (log_file == 
# 11 "src/utils/log.c" 3 4
                 ((void *)0)
# 11 "src/utils/log.c"
                     ) return;
  log_fp = fopen(log_file, "w");
  do { if (!(log_fp)) { fflush(
# 13 "src/utils/log.c" 3 4
 stdout
# 13 "src/utils/log.c"
 ); fprintf(
# 13 "src/utils/log.c" 3 4
...
# 13 "src/utils/log.c" 3 4
 stderr
# 13 "src/utils/log.c"
 , "Can not open '%s'", log_file); fprintf(
# 13 "src/utils/log.c" 3 4
 stderr
# 13 "src/utils/log.c"
...
# 13 "src/utils/log.c"
 "log_fp"
# 13 "src/utils/log.c" 3 4
 , "src/utils/log.c", 13, __extension__ __PRETTY_FUNCTION__); }))
# 13 "src/utils/log.c"
 ; } } while (0);
}


# 16 "src/utils/log.c" 3 4
_Bool 
# 16 "src/utils/log.c"
    log_enable() {
  extern uint64_t g_nr_guest_instr;
  return (g_nr_guest_instr >= (0)) && (g_nr_guest_instr <= (1024 * 1024 * 50));
}

...
# 7 "src/isa/riscv64/local-include/reg.h" 3 4
 ((void) sizeof ((
# 7 "src/isa/riscv64/local-include/reg.h"
 index >= 0 && index < 32
# 7 "src/isa/riscv64/local-include/reg.h" 3 4
...
# 7 "src/isa/riscv64/local-include/reg.h"
 "index >= 0 && index < 32"
# 7 "src/isa/riscv64/local-include/reg.h" 3 4
 , "src/isa/riscv64/local-include/reg.h", 7, __extension__ __PRETTY_FUNCTION__); }))
# 7 "src/isa/riscv64/local-include/reg.h"
                                                         ;
  return index;
}
...
# 15 "src/isa/riscv64/local-include/reg.h" 3 4
 ((void) sizeof ((
# 15 "src/isa/riscv64/local-include/reg.h"
 index >= 0 && index < 32
# 15 "src/isa/riscv64/local-include/reg.h" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 15 "src/isa/riscv64/local-include/reg.h"
...
# 15 "src/isa/riscv64/local-include/reg.h"
 "index >= 0 && index < 32"
# 15 "src/isa/riscv64/local-include/reg.h" 3 4
 , "src/isa/riscv64/local-include/reg.h", 15, __extension__ __PRETTY_FUNCTION__); }))
# 15 "src/isa/riscv64/local-include/reg.h"
                                                         ;
  return regsl[index];
}
...
# 24 "src/isa/riscv64/local-include/reg.h" 3 4
 ((void) sizeof ((
# 24 "src/isa/riscv64/local-include/reg.h"
 index >= 0 && index < 32
# 24 "src/isa/riscv64/local-include/reg.h" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 24 "src/isa/riscv64/local-include/reg.h"
...
# 24 "src/isa/riscv64/local-include/reg.h"
 "index >= 0 && index < 32"
# 24 "src/isa/riscv64/local-include/reg.h" 3 4
 , "src/isa/riscv64/local-include/reg.h", 24, __extension__ __PRETTY_FUNCTION__); }))
# 24 "src/isa/riscv64/local-include/reg.h"
                                                         ;
  return fpregsl[index];
}
# 4 "src/isa/riscv64/reg.c" 2
...
void isa_reg_display() {
  int i;
  for (i = 0; i < 32; i ++) {
    printf("%4s: " "0x%016lx" " ", regsl[i], cpu.gpr[i]._64);
    if (i % 4 == 3) {
      printf("\n");
    }
  }
  for (i = 0; i < 32; i ++) {
    printf("%4s: " "0x%016lx" " ", fpregsl[i], cpu.fpr[i]._64);
    if (i % 4 == 3) {
      printf("\n");
    }
  }
  printf("pc: " "0x%016lx" " mstatus: " "0x%016lx" " mcause: " "0x%016lx" " mepc: " "0x%016lx" "\n",
      cpu.pc, mstatus->val, mcause->val, mepc->val);
  printf("%22s sstatus: " "0x%016lx" " scause: " "0x%016lx" " sepc: " "0x%016lx" "\n",
      "", csrid_read(0x100), scause->val, sepc->val);
  printf("satp: " "0x%016lx" "\n", satp->val);
  printf("mip: " "0x%016lx" " mie: " "0x%016lx" " mscratch: " "0x%016lx" " sscratch: " "0x%016lx" "\n",
      mip->val, mie->val, mscratch->val, sscratch->val);
  printf("mideleg: " "0x%016lx" " medeleg: " "0x%016lx" "\n",
      mideleg->val, medeleg->val);
  printf("mtval: " "0x%016lx" " stval: " "0x%016lx" " mtvec: " "0x%016lx" " stvec: " "0x%016lx" "\n",
...
# 72 "src/isa/riscv64/reg.c"
  fflush(
# 72 "src/isa/riscv64/reg.c" 3 4
        stdout
# 72 "src/isa/riscv64/reg.c"
              );
}

rtlreg_t isa_reg_str2val(const char *s, 
# 75 "src/isa/riscv64/reg.c" 3 4
                                       _Bool 
# 75 "src/isa/riscv64/reg.c"
                                            *success) {
  int i;
  *success = 
# 77 "src/isa/riscv64/reg.c" 3 4
            1
# 77 "src/isa/riscv64/reg.c"
                ;
  for (i = 0; i < 32; i ++) {
    if (strcmp(regsl[i], s) == 0) return (cpu.gpr[check_reg_index(i)]._64);
  }

  if (strcmp("pc", s) == 0) return cpu.pc;

  *success = 
# 84 "src/isa/riscv64/reg.c" 3 4
            0
# 84 "src/isa/riscv64/reg.c"
                 ;
  return 0;
}


# 88 "src/isa/riscv64/reg.c" 3 4
_Bool 
# 88 "src/isa/riscv64/reg.c"
    able_to_take_cpt() {

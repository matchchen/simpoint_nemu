# 1 "src/isa/riscv64/instr/rva/amo.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "src/isa/riscv64/instr/rva/amo.c" 2
...
# 3 "src/isa/riscv64/instr/rva/amo.c" 2

__attribute__((cold))
void rtl_amo_slow_path(Decode *s, rtlreg_t *dest, const rtlreg_t *src1, const rtlreg_t *src2) {
  ...
  if (funct5 == 0b00010) {
    ...
    if (success) {
      ...
      if(isa_mmu_check(*((&s->src1)->preg), width, MEM_TYPE_WRITE) == MMU_TRANSLATE) {
        isa_mmu_translate(*((&s->src1)->preg), width, MEM_TYPE_WRITE);
      }
      do { if (cpu.mem_exception != 0) return; } while (0);
    }
  ...
  cpu.amo = 
# 40 "src/isa/riscv64/instr/rva/amo.c" 3 4
           1
# 40 "src/isa/riscv64/instr/rva/amo.c"
               ;
  rtl_lms(s, (&tmp_reg[0]), src1, 0, width, MMU_DYNAMIC);
  switch (funct5) {
    case 0b00001: rtl_mv (s, (&tmp_reg[1]), src2); break;
    case 0b00000: rtl_add(s, (&tmp_reg[1]), (&tmp_reg[0]), src2); break;
    case 0b01000: rtl_or (s, (&tmp_reg[1]), (&tmp_reg[0]), src2); break;
    case 0b01100: rtl_and(s, (&tmp_reg[1]), (&tmp_reg[0]), src2); break;
    case 0b00100: rtl_xor(s, (&tmp_reg[1]), (&tmp_reg[0]), src2); break;
    case 0b11100: *(&tmp_reg[1]) = (*(&tmp_reg[0]) > *src2 ? *(&tmp_reg[0]) : *src2); break;
    case 0b10100: *(&tmp_reg[1]) = ((sword_t)*(&tmp_reg[0]) > (sword_t)*src2 ? *(&tmp_reg[0]) : *src2); break;
    case 0b11000: *(&tmp_reg[1]) = (*(&tmp_reg[0]) < *src2 ? *(&tmp_reg[0]) : *src2); break;
    case 0b10000: *(&tmp_reg[1]) = ((sword_t)*(&tmp_reg[0]) < (sword_t)*src2 ? *(&tmp_reg[0]) : *src2); break;
    default: 
# 52 "src/isa/riscv64/instr/rva/amo.c" 3 4
            ((void) sizeof ((
# 52 "src/isa/riscv64/instr/rva/amo.c"
            0
# 52 "src/isa/riscv64/instr/rva/amo.c" 3 4
            ) ? 1 : 0), __extension__ ({ if (
# 52 "src/isa/riscv64/instr/rva/amo.c"
...
# 52 "src/isa/riscv64/instr/rva/amo.c"
            "0"
# 52 "src/isa/riscv64/instr/rva/amo.c" 3 4
            , "src/isa/riscv64/instr/rva/amo.c", 52, __extension__ __PRETTY_FUNCTION__); }))
# 52 "src/isa/riscv64/instr/rva/amo.c"
                     ;
  }
  rtl_sm(s, (&tmp_reg[1]), src1, 0, width, MMU_DYNAMIC);
  rtl_mv(s, dest, (&tmp_reg[0]));
  cpu.amo = 
# 56 "src/isa/riscv64/instr/rva/amo.c" 3 4
           0
# 56 "src/isa/riscv64/instr/rva/amo.c"
                ;
}

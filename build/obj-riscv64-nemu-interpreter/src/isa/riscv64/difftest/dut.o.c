...
# 2 "src/isa/riscv64/difftest/dut.c" 2
...
uint8_t *get_pmem();
# 3 "src/isa/riscv64/difftest/dut.c" 2
...
# 4 "src/isa/riscv64/difftest/dut.c" 2
...
# 7 "src/isa/riscv64/difftest/../local-include/reg.h" 3 4
 ((void) sizeof ((
# 7 "src/isa/riscv64/difftest/../local-include/reg.h"
 index >= 0 && index < 32
# 7 "src/isa/riscv64/difftest/../local-include/reg.h" 3 4
...
# 7 "src/isa/riscv64/difftest/../local-include/reg.h"
 "index >= 0 && index < 32"
# 7 "src/isa/riscv64/difftest/../local-include/reg.h" 3 4
 , "src/isa/riscv64/difftest/../local-include/reg.h", 7, __extension__ __PRETTY_FUNCTION__); }))
# 7 "src/isa/riscv64/difftest/../local-include/reg.h"
                                                         ;
  return index;
}
...
# 15 "src/isa/riscv64/difftest/../local-include/reg.h" 3 4
 ((void) sizeof ((
# 15 "src/isa/riscv64/difftest/../local-include/reg.h"
 index >= 0 && index < 32
# 15 "src/isa/riscv64/difftest/../local-include/reg.h" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 15 "src/isa/riscv64/difftest/../local-include/reg.h"
...
# 15 "src/isa/riscv64/difftest/../local-include/reg.h"
 "index >= 0 && index < 32"
# 15 "src/isa/riscv64/difftest/../local-include/reg.h" 3 4
 , "src/isa/riscv64/difftest/../local-include/reg.h", 15, __extension__ __PRETTY_FUNCTION__); }))
# 15 "src/isa/riscv64/difftest/../local-include/reg.h"
                                                         ;
  return regsl[index];
}
...
# 24 "src/isa/riscv64/difftest/../local-include/reg.h" 3 4
 ((void) sizeof ((
# 24 "src/isa/riscv64/difftest/../local-include/reg.h"
 index >= 0 && index < 32
# 24 "src/isa/riscv64/difftest/../local-include/reg.h" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 24 "src/isa/riscv64/difftest/../local-include/reg.h"
...
# 24 "src/isa/riscv64/difftest/../local-include/reg.h"
 "index >= 0 && index < 32"
# 24 "src/isa/riscv64/difftest/../local-include/reg.h" 3 4
 , "src/isa/riscv64/difftest/../local-include/reg.h", 24, __extension__ __PRETTY_FUNCTION__); }))
# 24 "src/isa/riscv64/difftest/../local-include/reg.h"
                                                         ;
  return fpregsl[index];
}
# 5 "src/isa/riscv64/difftest/dut.c" 2



# 7 "src/isa/riscv64/difftest/dut.c" 3 4
_Bool 
# 7 "src/isa/riscv64/difftest/dut.c"
    isa_difftest_checkregs(CPU_state *ref_r, vaddr_t pc) {
  if (memcmp(&cpu.gpr[1], &ref_r->gpr[1], (sizeof(uint64_t) * (32 + 32 + 1 + 6 + 11 + 1)) - sizeof(cpu.gpr[0]))) {
    int i;

    for (i = 1; i < (int)(sizeof(cpu.gpr) / sizeof(cpu.gpr[0])); i ++) {
      difftest_check_reg(reg_name(i, 4), pc, ref_r->gpr[i]._64, cpu.gpr[i]._64);
    }
    difftest_check_reg("pc", pc, ref_r->pc, cpu.pc);
    return 
# 15 "src/isa/riscv64/difftest/dut.c" 3 4
          0
# 15 "src/isa/riscv64/difftest/dut.c"
               ;
  }
  return 
# 17 "src/isa/riscv64/difftest/dut.c" 3 4
        1
# 17 "src/isa/riscv64/difftest/dut.c"
            ;
}

void isa_difftest_attach() {
  ref_difftest_memcpy(0x800a0000, guest_to_host(0x800a0000), 0x50000000, DIFFTEST_TO_REF);

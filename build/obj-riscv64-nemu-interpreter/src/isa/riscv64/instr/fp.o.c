...
# 5 "src/isa/riscv64/instr/../local-include/csr.h" 2
...
word_t pmp_tor_mask();
# 2 "src/isa/riscv64/instr/fp.c" 2
# 1 "src/isa/riscv64/instr/../local-include/intr.h" 1
...
# 5 "src/isa/riscv64/instr/../local-include/intr.h" 2
...
# 31 "src/isa/riscv64/instr/../local-include/intr.h" 3 4
_Bool 
# 31 "src/isa/riscv64/instr/../local-include/intr.h"
    intr_deleg_S(word_t exceptionNO);
# 3 "src/isa/riscv64/instr/fp.c" 2
...
# 4 "src/isa/riscv64/instr/fp.c" 2
...
# 5 "src/isa/riscv64/instr/fp.c" 2
...
void fp_update_rm_cache(uint32_t rm) {
  switch (rm) {
    ...
    default: 
# 14 "src/isa/riscv64/instr/fp.c" 3 4
            ((void) sizeof ((
# 14 "src/isa/riscv64/instr/fp.c"
            0
# 14 "src/isa/riscv64/instr/fp.c" 3 4
            ) ? 1 : 0), __extension__ ({ if (
# 14 "src/isa/riscv64/instr/fp.c"
...
# 14 "src/isa/riscv64/instr/fp.c"
            "0"
# 14 "src/isa/riscv64/instr/fp.c" 3 4
            , "src/isa/riscv64/instr/fp.c", 14, __extension__ __PRETTY_FUNCTION__); }))
# 14 "src/isa/riscv64/instr/fp.c"
                     ;
  }
}
...
# 18 "src/isa/riscv64/instr/fp.c" 3 4
_Bool 
# 18 "src/isa/riscv64/instr/fp.c"
    fp_enable() {
  return mstatus->fs != 0;
}
...
uint32_t isa_fp_get_rm(Decode *s) {
  ...
  if (__builtin_expect(rm == 7, 1)) { return nemu_rm_cache; }
  switch (rm) {
...
void isa_fp_csr_check() {
  if(__builtin_expect(mstatus->fs == 0, 0)){
    longjmp_exception(EX_II);
    
# 57 "src/isa/riscv64/instr/fp.c" 3 4
   ((void) sizeof ((
# 57 "src/isa/riscv64/instr/fp.c"
   0
# 57 "src/isa/riscv64/instr/fp.c" 3 4
   ) ? 1 : 0), __extension__ ({ if (
# 57 "src/isa/riscv64/instr/fp.c"
...
# 57 "src/isa/riscv64/instr/fp.c"
   "0"
# 57 "src/isa/riscv64/instr/fp.c" 3 4
   , "src/isa/riscv64/instr/fp.c", 57, __extension__ __PRETTY_FUNCTION__); }))
# 57 "src/isa/riscv64/instr/fp.c"
            ;
  }
}

...
# 2 "src/utils/iqueue.c" 2




# 5 "src/utils/iqueue.c"
static struct {
  vaddr_t pc;
  uint8_t instr[20];
  uint8_t ilen;
...
# 15 "src/utils/iqueue.c" 3 4
 ((void) sizeof ((
# 15 "src/utils/iqueue.c"
 ilen < 20
# 15 "src/utils/iqueue.c" 3 4
...
# 15 "src/utils/iqueue.c"
 "ilen < 20"
# 15 "src/utils/iqueue.c" 3 4
 , "src/utils/iqueue.c", 15, __extension__ __PRETTY_FUNCTION__); }))
# 15 "src/utils/iqueue.c"
                  ;
...
void iqueue_dump() {
  int i;
  int victim_idx = (q_idx - 1) % (1 << 5);
  printf("======== instruction queue =========\n");
  for (i = 0; i < (1 << 5); i ++) {
    printf("%5s " "0x%016lx" ": ", (i == victim_idx ? "-->" : ""), iqueue[i].pc);
    int j;

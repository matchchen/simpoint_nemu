...
# 2 "src/isa/riscv64/system/intr.c" 2
...
word_t pmp_tor_mask();
# 3 "src/isa/riscv64/system/intr.c" 2
...
# 4 "src/isa/riscv64/system/intr.c" 2
...
# 14 "src/isa/riscv64/system/intr.c" 3 4
_Bool 
# 14 "src/isa/riscv64/system/intr.c"
    intr_deleg_S(word_t exceptionNO) {
  word_t deleg = (exceptionNO & (1ULL << 63) ? mideleg->val : medeleg->val);
  
# 16 "src/isa/riscv64/system/intr.c" 3 4
 _Bool 
# 16 "src/isa/riscv64/system/intr.c"
      delegS = ((deleg & (1 << (exceptionNO & 0xf))) != 0) && (cpu.mode < MODE_M);
  return delegS;
}

static word_t get_trap_pc(word_t xtvec, word_t xcause) {
  word_t base = (xtvec >> 2) << 2;
  word_t mode = (xtvec & 0x1);
  
# 23 "src/isa/riscv64/system/intr.c" 3 4
 _Bool 
# 23 "src/isa/riscv64/system/intr.c"
      is_intr = (xcause >> (sizeof(word_t)-1)) == 1;
  
# 24 "src/isa/riscv64/system/intr.c" 3 4
 _Bool 
# 24 "src/isa/riscv64/system/intr.c"
      casue_no = xcause & 0xf;
...
# 36 "src/isa/riscv64/system/intr.c" 3 4
 _Bool 
# 36 "src/isa/riscv64/system/intr.c"
      delegS = intr_deleg_S(NO);
...
# 88 "src/isa/riscv64/system/intr.c" 3 4
     _Bool 
# 88 "src/isa/riscv64/system/intr.c"
          deleg = (mideleg->val & (1 << irq)) != 0;
      
# 89 "src/isa/riscv64/system/intr.c" 3 4
     _Bool 
# 89 "src/isa/riscv64/system/intr.c"
          global_enable = (deleg ? ((cpu.mode == MODE_S) && mstatus->sie) || (cpu.mode < MODE_S) :
          ((cpu.mode == MODE_M) && mstatus->mie) || (cpu.mode < MODE_M));
      if (global_enable) return irq | (1ULL << 63);
    }
  }
  return ((word_t)-1);
}

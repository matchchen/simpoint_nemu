...
# 69 "src/utils/expr.c" 3 4
     stderr
# 69 "src/utils/expr.c"
     , "regex compilation failed: %s\n%s", error_msg, rules[i].regex); fprintf(
# 69 "src/utils/expr.c" 3 4
     stderr
# 69 "src/utils/expr.c"
...
# 69 "src/utils/expr.c"
     "0"
# 69 "src/utils/expr.c" 3 4
     , "src/utils/expr.c", 69, __extension__ __PRETTY_FUNCTION__); }))
# 69 "src/utils/expr.c"
     ; } } while (0);
    }
  }
...
# 104 "src/utils/expr.c"
    ...
    if (i == (int)(sizeof(rules) / sizeof(rules[0]))) {
      ...
      return 
# 129 "src/utils/expr.c" 3 4
            0
# 129 "src/utils/expr.c"
                 ;
    }
  }

  return 
# 133 "src/utils/expr.c" 3 4
        1
# 133 "src/utils/expr.c"
            ;
}
...
static int op_prec(int t) {
  switch (t) {
    ...
    case TK_OR: return 9;
    default: 
# 145 "src/utils/expr.c" 3 4
            ((void) sizeof ((
# 145 "src/utils/expr.c"
            0
# 145 "src/utils/expr.c" 3 4
            ) ? 1 : 0), __extension__ ({ if (
# 145 "src/utils/expr.c"
...
# 145 "src/utils/expr.c"
            "0"
# 145 "src/utils/expr.c" 3 4
            , "src/utils/expr.c", 145, __extension__ __PRETTY_FUNCTION__); }))
# 145 "src/utils/expr.c"
                     ;
  }
}
...
static int find_dominated_op(int s, int e, 
# 153 "src/utils/expr.c" 3 4
                                          _Bool 
# 153 "src/utils/expr.c"
                                               *success) {
  int i;
  int bracket_level = 0;
  int dominated_op = -1;
  for (i = s; i <= e; i ++) {
    switch (tokens[i].type) {
      ...
      case ')':
        ...
        if (bracket_level < 0) {
          *success = 
# 168 "src/utils/expr.c" 3 4
                    0
# 168 "src/utils/expr.c"
                         ;
          return 0;
        }
        break;
...
static rtlreg_t eval(int s, int e, 
# 191 "src/utils/expr.c" 3 4
                                  _Bool 
# 191 "src/utils/expr.c"
                                       *success) {
  if (s > e) {

    *success = 
# 194 "src/utils/expr.c" 3 4
              0
# 194 "src/utils/expr.c"
                   ;
    return 0;
  }
  else if (s == e) {
    ...
    switch (tokens[s].type) {
      case TK_REG: val = isa_reg_str2val(tokens[s].str + 1, success);
                if (!*success) { return 0; }
                break;

      case TK_NUM: val = strtoul(tokens[s].str, 
# 205 "src/utils/expr.c" 3 4
                                               ((void *)0)
# 205 "src/utils/expr.c"
                                                   , 0); break;
      default: 
# 206 "src/utils/expr.c" 3 4
              ((void) sizeof ((
# 206 "src/utils/expr.c"
              0
# 206 "src/utils/expr.c" 3 4
              ) ? 1 : 0), __extension__ ({ if (
# 206 "src/utils/expr.c"
...
# 206 "src/utils/expr.c"
              "0"
# 206 "src/utils/expr.c" 3 4
              , "src/utils/expr.c", 206, __extension__ __PRETTY_FUNCTION__); }))
# 206 "src/utils/expr.c"
                       ;
    }

    *success = 
# 209 "src/utils/expr.c" 3 4
              1
# 209 "src/utils/expr.c"
                  ;
    return val;
  }
    ...
    if (op_type == '!' || op_type == TK_NEG || op_type == TK_REF) {
      ...
      switch (op_type) {
        ...
        default: 
# 228 "src/utils/expr.c" 3 4
                ((void) sizeof ((
# 228 "src/utils/expr.c"
                0
# 228 "src/utils/expr.c" 3 4
                ) ? 1 : 0), __extension__ ({ if (
# 228 "src/utils/expr.c"
...
# 228 "src/utils/expr.c"
                "0"
# 228 "src/utils/expr.c" 3 4
                , "src/utils/expr.c", 228, __extension__ __PRETTY_FUNCTION__); }))
# 228 "src/utils/expr.c"
                         ;
      }
    }
    ...
    switch (op_type) {
      ...
      default: 
# 247 "src/utils/expr.c" 3 4
              ((void) sizeof ((
# 247 "src/utils/expr.c"
              0
# 247 "src/utils/expr.c" 3 4
              ) ? 1 : 0), __extension__ ({ if (
# 247 "src/utils/expr.c"
...
# 247 "src/utils/expr.c"
              "0"
# 247 "src/utils/expr.c" 3 4
              , "src/utils/expr.c", 247, __extension__ __PRETTY_FUNCTION__); }))
# 247 "src/utils/expr.c"
                       ;
    }
  }
...
word_t expr(char *e, 
# 253 "src/utils/expr.c" 3 4
                    _Bool 
# 253 "src/utils/expr.c"
                         *success) {
  if (!make_token(e)) {
    *success = 
# 255 "src/utils/expr.c" 3 4
              0
# 255 "src/utils/expr.c"
                   ;
    return 0;
  }
# 267 "src/utils/expr.c"
  int i;
  int prev_type;

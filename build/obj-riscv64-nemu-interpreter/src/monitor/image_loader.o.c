...
# 2 "src/monitor/image_loader.c" 2
...
# 3 "src/monitor/image_loader.c" 2
...
uint8_t *get_pmem();
# 5 "src/monitor/image_loader.c" 2
...
extern int gzvprintf (gzFile file, const char *format, va_list va)
                                                              ...
                                                              ;
# 6 "src/monitor/image_loader.c" 2
...
# 7 "src/monitor/image_loader.c" 2
...
# 8 "src/monitor/image_loader.c" 2
...
# 14 "src/monitor/image_loader.c"
long load_gz_img(const char *filename) {
  gzFile compressed_mem = gzopen(filename, "rb");
  do { if (!(compressed_mem)) { fflush(
# 16 "src/monitor/image_loader.c" 3 4
 stdout
# 16 "src/monitor/image_loader.c"
 ); fprintf(
# 16 "src/monitor/image_loader.c" 3 4
 stderr
# 16 "src/monitor/image_loader.c"
...
# 16 "src/monitor/image_loader.c" 3 4
 stderr
# 16 "src/monitor/image_loader.c"
 , "Can not open '%s'", filename); fprintf(
# 16 "src/monitor/image_loader.c" 3 4
 stderr
# 16 "src/monitor/image_loader.c"
...
# 16 "src/monitor/image_loader.c"
 "compressed_mem"
# 16 "src/monitor/image_loader.c" 3 4
 , "src/monitor/image_loader.c", 16, __extension__ __PRETTY_FUNCTION__); }))
# 16 "src/monitor/image_loader.c"
 ; } } while (0);

  const uint32_t chunk_size = 16384;
  uint8_t *temp_page = (uint8_t *)calloc(chunk_size, sizeof(long));
  uint8_t *pmem_start = (uint8_t *)guest_to_host((0x800a0000 + 0x0));
  uint8_t *pmem_current;


  uint64_t curr_size = 0;
  while (curr_size < 0x50000000) {
  ...
  do { if (!(left_bytes == 0)) { fflush(
# 42 "src/monitor/image_loader.c" 3 4
 stdout
# 42 "src/monitor/image_loader.c"
 ); fprintf(
# 42 "src/monitor/image_loader.c" 3 4
 stderr
# 42 "src/monitor/image_loader.c"
...
# 42 "src/monitor/image_loader.c" 3 4
 stderr
# 42 "src/monitor/image_loader.c"
 , "File size is larger than buf_size!\n"); fprintf(
# 42 "src/monitor/image_loader.c" 3 4
 stderr
# 42 "src/monitor/image_loader.c"
 , "\33[0m\n"); extern void isa_reg_display(); extern void monitor_statistic(); isa_reg_display(); monitor_statistic(); 
...
# 42 "src/monitor/image_loader.c"
 "left_bytes == 0"
# 42 "src/monitor/image_loader.c" 3 4
 , "src/monitor/image_loader.c", 42, __extension__ __PRETTY_FUNCTION__); }))
# 42 "src/monitor/image_loader.c"
 ; } } while (0);

  free(temp_page);
  do { if (!(!gzclose(compressed_mem))) { fflush(
# 45 "src/monitor/image_loader.c" 3 4
 stdout
# 45 "src/monitor/image_loader.c"
 ); fprintf(
# 45 "src/monitor/image_loader.c" 3 4
 stderr
# 45 "src/monitor/image_loader.c"
...
# 45 "src/monitor/image_loader.c"
 "!gzclose(compressed_mem)"
# 45 "src/monitor/image_loader.c" 3 4
 , "src/monitor/image_loader.c", 45, __extension__ __PRETTY_FUNCTION__); }))
# 45 "src/monitor/image_loader.c"
 ; } } while (0);
  return curr_size;
}
...
long load_img(char* img_name, char *which_img, uint64_t load_start, size_t img_size) {
  ...
  do { printf("\33[1;34m[%s:%d,%s] " "Loading %s: %s\n" "\33[0m\n", "src/monitor/image_loader.c", 56, __func__, which_img, img_name); ; } while (0);
  if (img_name == 
# 57 "src/monitor/image_loader.c" 3 4
                 ((void *)0)
# 57 "src/monitor/image_loader.c"
                     ) {
    do { printf("\33[1;34m[%s:%d,%s] " "No image is given. Use the default build-in image/restorer." "\33[0m\n", "src/monitor/image_loader.c", 58, __func__); ; } while (0);
    return 4096;
  }

  if (is_gz_file(loading_img)) {
    extern 
# 63 "src/monitor/image_loader.c" 3 4
          _Bool 
# 63 "src/monitor/image_loader.c"
               map_image_as_output_cpt;
    
# 64 "src/monitor/image_loader.c" 3 4
   ((void) sizeof ((
# 64 "src/monitor/image_loader.c"
   !map_image_as_output_cpt && "Cannot map gz as output cpt"
# 64 "src/monitor/image_loader.c" 3 4
   ) ? 1 : 0), __extension__ ({ if (
# 64 "src/monitor/image_loader.c"
   !map_image_as_output_cpt && "Cannot map gz as output cpt"
...
# 64 "src/monitor/image_loader.c"
   "!map_image_as_output_cpt && \"Cannot map gz as output cpt\""
# 64 "src/monitor/image_loader.c" 3 4
   , "src/monitor/image_loader.c", 64, __extension__ __PRETTY_FUNCTION__); }))
# 64 "src/monitor/image_loader.c"
                                                                     ;

    do { printf("\33[1;34m[%s:%d,%s] " "Loading GZ image %s" "\33[0m\n", "src/monitor/image_loader.c", 66, __func__, loading_img); ; } while (0);
  ...
  do { if (!(fp)) { fflush(
# 76 "src/monitor/image_loader.c" 3 4
 stdout
# 76 "src/monitor/image_loader.c"
 ); fprintf(
# 76 "src/monitor/image_loader.c" 3 4
 stderr
# 76 "src/monitor/image_loader.c"
...
# 76 "src/monitor/image_loader.c" 3 4
 stderr
# 76 "src/monitor/image_loader.c"
 , "Can not open '%s'", loading_img); fprintf(
# 76 "src/monitor/image_loader.c" 3 4
 stderr
# 76 "src/monitor/image_loader.c"
 , "\33[0m\n"); extern void isa_reg_display(); extern void monitor_statistic(); isa_reg_display(); monitor_statistic(); 
...
# 76 "src/monitor/image_loader.c"
 "fp"
# 76 "src/monitor/image_loader.c" 3 4
 , "src/monitor/image_loader.c", 76, __extension__ __PRETTY_FUNCTION__); }))
# 76 "src/monitor/image_loader.c"
 ; } } while (0);

  size_t size;
  fseek(fp, 0, 
# 79 "src/monitor/image_loader.c" 3 4
              2
# 79 "src/monitor/image_loader.c"
                      );
  size = ftell(fp);
  fseek(fp, 0, 
# 81 "src/monitor/image_loader.c" 3 4
              0
# 81 "src/monitor/image_loader.c"
                      );
  if (img_size != 0 && (size > img_size)) {
    do { printf("\33[1;34m[%s:%d,%s] " "Warning: size is larger than img_size(upper limit), please check if code is missing. size:%lx img_size:%lx" "\33[0m\n", "src/monitor/image_loader.c", 83, __func__, size, img_size); ; } while (0);
    size = img_size;
  }

  if (size < 512UL*1024UL*1024UL) {
    do { printf("\33[1;34m[%s:%d,%s] " "Fread from file because less than 512MB\n" "\33[0m\n", "src/monitor/image_loader.c", 88, __func__); ; } while (0);
...
# 94 "src/monitor/image_loader.c" 3 4
   ((void) sizeof ((
# 94 "src/monitor/image_loader.c"
   ret == 1
# 94 "src/monitor/image_loader.c" 3 4
   ) ? 1 : 0), __extension__ ({ if (
# 94 "src/monitor/image_loader.c"
...
# 94 "src/monitor/image_loader.c"
   "ret == 1"
# 94 "src/monitor/image_loader.c" 3 4
   , "src/monitor/image_loader.c", 94, __extension__ __PRETTY_FUNCTION__); }))
# 94 "src/monitor/image_loader.c"
                   ;
    fclose(fp);
...
# 99 "src/monitor/image_loader.c" 3 4
   ((void) sizeof ((
# 99 "src/monitor/image_loader.c"
   !0
# 99 "src/monitor/image_loader.c" 3 4
   ) ? 1 : 0), __extension__ ({ if (
# 99 "src/monitor/image_loader.c"
...
# 99 "src/monitor/image_loader.c"
   "!ISDEF(CONFIG_SHARE)"
# 99 "src/monitor/image_loader.c" 3 4
   , "src/monitor/image_loader.c", 99, __extension__ __PRETTY_FUNCTION__); }))
# 99 "src/monitor/image_loader.c"
                               ;
    
# 100 "src/monitor/image_loader.c" 3 4
   ((void) sizeof ((
# 100 "src/monitor/image_loader.c"
   size % 8 == 0
# 100 "src/monitor/image_loader.c" 3 4
   ) ? 1 : 0), __extension__ ({ if (
# 100 "src/monitor/image_loader.c"
...
# 100 "src/monitor/image_loader.c"
   "size % 8 == 0"
# 100 "src/monitor/image_loader.c" 3 4
   , "src/monitor/image_loader.c", 100, __extension__ __PRETTY_FUNCTION__); }))
# 100 "src/monitor/image_loader.c"
                        ;

    do { printf("\33[1;34m[%s:%d,%s] " "Mmap and read from file because larger than 512MB\n" "\33[0m\n", "src/monitor/image_loader.c", 102, __func__); ; } while (0);
    extern uint8_t *get_pmem();
    uint64_t *current = (uint64_t *) get_pmem();
    int fd = open(img_name, 
# 105 "src/monitor/image_loader.c" 3 4
                           00
# 105 "src/monitor/image_loader.c"
                                   , (mode_t)0600);
    if (!fd) {
      do { if (!(0)) { fflush(
# 107 "src/monitor/image_loader.c" 3 4
     stdout
# 107 "src/monitor/image_loader.c"
     ); fprintf(
# 107 "src/monitor/image_loader.c" 3 4
     stderr
# 107 "src/monitor/image_loader.c"
...
# 107 "src/monitor/image_loader.c" 3 4
     stderr
# 107 "src/monitor/image_loader.c"
     , "Failed to read file %s", img_name); fprintf(
# 107 "src/monitor/image_loader.c" 3 4
     stderr
# 107 "src/monitor/image_loader.c"
     , "\33[0m\n"); extern void isa_reg_display(); extern void monitor_statistic(); isa_reg_display(); monitor_statistic(); 
...
# 107 "src/monitor/image_loader.c"
     "0"
# 107 "src/monitor/image_loader.c" 3 4
     , "src/monitor/image_loader.c", 107, __extension__ __PRETTY_FUNCTION__); }))
# 107 "src/monitor/image_loader.c"
     ; } } while (0);
    }
    uint64_t *img_start = (uint64_t*) mmap(
# 109 "src/monitor/image_loader.c" 3 4
                                          ((void *)0)
# 109 "src/monitor/image_loader.c"
                                              , size, 
# 109 "src/monitor/image_loader.c" 3 4
                                                      0x1
# 109 "src/monitor/image_loader.c"
...
# 109 "src/monitor/image_loader.c"
  ...
  do { printf("\33[1;34m[%s:%d,%s] " "Read %lu bytes from file %s to 0x%lx" "\33[0m\n", "src/monitor/image_loader.c", 124, __func__, size, img_name, load_start); ; } while (0);

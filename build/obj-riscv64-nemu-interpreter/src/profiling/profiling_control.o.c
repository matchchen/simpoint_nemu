# 1 "src/profiling/profiling_control.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "src/profiling/profiling_control.c" 2

int profiling_state = NoProfiling;

# 4 "src/profiling/profiling_control.c" 3 4
_Bool 
# 4 "src/profiling/profiling_control.c"
    checkpoint_taking = 
# 4 "src/profiling/profiling_control.c" 3 4
                        0
# 4 "src/profiling/profiling_control.c"
...
# 5 "src/profiling/profiling_control.c" 3 4
_Bool 
# 5 "src/profiling/profiling_control.c"
    checkpoint_restoring = 
# 5 "src/profiling/profiling_control.c" 3 4
                           0
# 5 "src/profiling/profiling_control.c"
...
# 8 "src/profiling/profiling_control.c" 3 4
_Bool 
# 8 "src/profiling/profiling_control.c"
    wait_manual_oneshot_cpt = 
# 8 "src/profiling/profiling_control.c" 3 4
                              0
# 8 "src/profiling/profiling_control.c"
...
# 9 "src/profiling/profiling_control.c" 3 4
_Bool 
# 9 "src/profiling/profiling_control.c"
    wait_manual_uniform_cpt = 
# 9 "src/profiling/profiling_control.c" 3 4
                              0
# 9 "src/profiling/profiling_control.c"
...
# 10 "src/profiling/profiling_control.c" 3 4
_Bool 
# 10 "src/profiling/profiling_control.c"
    recvd_manual_oneshot_cpt = 
# 10 "src/profiling/profiling_control.c" 3 4
                               0
# 10 "src/profiling/profiling_control.c"
...
# 11 "src/profiling/profiling_control.c" 3 4
_Bool 
# 11 "src/profiling/profiling_control.c"
    recvd_manual_uniform_cpt = 
# 11 "src/profiling/profiling_control.c" 3 4
                               0
# 11 "src/profiling/profiling_control.c"
...
# 13 "src/profiling/profiling_control.c" 3 4
_Bool 
# 13 "src/profiling/profiling_control.c"
    profiling_started = 
# 13 "src/profiling/profiling_control.c" 3 4
                        0
# 13 "src/profiling/profiling_control.c"
...
# 14 "src/profiling/profiling_control.c" 3 4
_Bool 
# 14 "src/profiling/profiling_control.c"
    force_cpt_mmode = 
# 14 "src/profiling/profiling_control.c" 3 4
                      0
# 14 "src/profiling/profiling_control.c"
...
void reset_inst_counters() {
  ...
  extern 
# 18 "src/profiling/profiling_control.c" 3 4
        _Bool 
# 18 "src/profiling/profiling_control.c"
             profiling_started;
  do { printf("\33[1;34m[%s:%d,%s] " "Start profiling, resetting inst count from %lu to 1, (n_remain_total will not be cleared)\n" "\33[0m\n", "src/profiling/profiling_control.c", 19, __func__, g_nr_guest_instr); ; } while (0);
  g_nr_guest_instr = 1;
  profiling_started = 
# 21 "src/profiling/profiling_control.c" 3 4
                     1
# 21 "src/profiling/profiling_control.c"
                         ;
}

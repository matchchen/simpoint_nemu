...
# 15 "src/memory/vaddr.c" 2
# 96 "src/memory/vaddr.c"
static inline word_t vaddr_read_internal(void *s, vaddr_t addr, int len, int type, int mmu_mode) {
  ...
  if (__builtin_expect(mmu_mode == MMU_DYNAMIC, 0)) {
    do { if (dflag_mem == dflag_mem && 0) do { printf("\33[1;34m[%s:%d,%s] " "Checking mmu when MMU_DYN" "\33[0m\n", "src/memory/vaddr.c", 104, __func__); ; } while (0); if (dflag_mem == dflag_translate && 0) do { printf("\33[1;34m[%s:%d,%s] " "Checking mmu when MMU_DYN" "\33[0m\n", "src/memory/vaddr.c", 104, __func__); ; } while (0); if (dflag_mem == dflag_trace_inst && 0) do { printf("\33[1;34m[%s:%d,%s] " "Checking mmu when MMU_DYN" "\33[0m\n", "src/memory/vaddr.c", 104, __func__); ; } while (0); if (dflag_mem == dflag_trace_inst_dasm && 0) do { printf("\33[1;34m[%s:%d,%s] " "Checking mmu when MMU_DYN" "\33[0m\n", "src/memory/vaddr.c", 104, __func__); ; } while (0); if (dflag_mem == dflag_trace_bb && 0) do { printf("\33[1;34m[%s:%d,%s] " "Checking mmu when MMU_DYN" "\33[0m\n", "src/memory/vaddr.c", 104, __func__); ; } while (0); if (dflag_mem == dflag_betapoint && 0) do { printf("\33[1;34m[%s:%d,%s] " "Checking mmu when MMU_DYN" "\33[0m\n", "src/memory/vaddr.c", 104, __func__); ; } while (0); if (dflag_mem == dflag_exit && 0) do { printf("\33[1;34m[%s:%d,%s] " "Checking mmu when MMU_DYN" "\33[0m\n", "src/memory/vaddr.c", 104, __func__); ; } while (0); if (dflag_mem == dflag_memprof && 0) do { printf("\33[1;34m[%s:%d,%s] " "Checking mmu when MMU_DYN" "\33[0m\n", "src/memory/vaddr.c", 104, __func__); ; } while (0); if (dflag_mem == dflag_ctrlprof && 0) do { printf("\33[1;34m[%s:%d,%s] " "Checking mmu when MMU_DYN" "\33[0m\n", "src/memory/vaddr.c", 104, __func__); ; } while (0); if (dflag_mem == dflag_simpoint && 0) do { printf("\33[1;34m[%s:%d,%s] " "Checking mmu when MMU_DYN" "\33[0m\n", "src/memory/vaddr.c", 104, __func__); ; } while (0); } while (0);
    mmu_mode = isa_mmu_check(addr, len, type);
  }
  if (mmu_mode == MMU_DIRECT) {
    do { if (dflag_mem == dflag_mem && 0) do { printf("\33[1;34m[%s:%d,%s] " "Paddr reading directly" "\33[0m\n", "src/memory/vaddr.c", 108, __func__); ; } while (0); if (dflag_mem == dflag_translate && 0) do { printf("\33[1;34m[%s:%d,%s] " "Paddr reading directly" "\33[0m\n", "src/memory/vaddr.c", 108, __func__); ; } while (0); if (dflag_mem == dflag_trace_inst && 0) do { printf("\33[1;34m[%s:%d,%s] " "Paddr reading directly" "\33[0m\n", "src/memory/vaddr.c", 108, __func__); ; } while (0); if (dflag_mem == dflag_trace_inst_dasm && 0) do { printf("\33[1;34m[%s:%d,%s] " "Paddr reading directly" "\33[0m\n", "src/memory/vaddr.c", 108, __func__); ; } while (0); if (dflag_mem == dflag_trace_bb && 0) do { printf("\33[1;34m[%s:%d,%s] " "Paddr reading directly" "\33[0m\n", "src/memory/vaddr.c", 108, __func__); ; } while (0); if (dflag_mem == dflag_betapoint && 0) do { printf("\33[1;34m[%s:%d,%s] " "Paddr reading directly" "\33[0m\n", "src/memory/vaddr.c", 108, __func__); ; } while (0); if (dflag_mem == dflag_exit && 0) do { printf("\33[1;34m[%s:%d,%s] " "Paddr reading directly" "\33[0m\n", "src/memory/vaddr.c", 108, __func__); ; } while (0); if (dflag_mem == dflag_memprof && 0) do { printf("\33[1;34m[%s:%d,%s] " "Paddr reading directly" "\33[0m\n", "src/memory/vaddr.c", 108, __func__); ; } while (0); if (dflag_mem == dflag_ctrlprof && 0) do { printf("\33[1;34m[%s:%d,%s] " "Paddr reading directly" "\33[0m\n", "src/memory/vaddr.c", 108, __func__); ; } while (0); if (dflag_mem == dflag_simpoint && 0) do { printf("\33[1;34m[%s:%d,%s] " "Paddr reading directly" "\33[0m\n", "src/memory/vaddr.c", 108, __func__); ; } while (0); } while (0);
# 120 "src/memory/vaddr.c"
    return paddr_read(addr, len, type, cpu.mode, addr);
  }

  return hosttlb_read ((struct Decode *)s, addr, len, type);

  return 0;
}

word_t vaddr_ifetch(vaddr_t addr, int len) {
  return vaddr_read_internal(
# 129 "src/memory/vaddr.c" 3 4
                            ((void *)0)
# 129 "src/memory/vaddr.c"
                                , addr, len, MEM_TYPE_IFETCH, MMU_DYNAMIC);
}

word_t vaddr_read(struct Decode *s, vaddr_t addr, int len, int mmu_mode) {
  do { if (dflag_mem == dflag_mem && 0) do { printf("\33[1;34m[%s:%d,%s] " "Reading vaddr %lx" "\33[0m\n", "src/memory/vaddr.c", 133, __func__, addr); ; } while (0); if (dflag_mem == dflag_translate && 0) do { printf("\33[1;34m[%s:%d,%s] " "Reading vaddr %lx" "\33[0m\n", "src/memory/vaddr.c", 133, __func__, addr); ; } while (0); if (dflag_mem == dflag_trace_inst && 0) do { printf("\33[1;34m[%s:%d,%s] " "Reading vaddr %lx" "\33[0m\n", "src/memory/vaddr.c", 133, __func__, addr); ; } while (0); if (dflag_mem == dflag_trace_inst_dasm && 0) do { printf("\33[1;34m[%s:%d,%s] " "Reading vaddr %lx" "\33[0m\n", "src/memory/vaddr.c", 133, __func__, addr); ; } while (0); if (dflag_mem == dflag_trace_bb && 0) do { printf("\33[1;34m[%s:%d,%s] " "Reading vaddr %lx" "\33[0m\n", "src/memory/vaddr.c", 133, __func__, addr); ; } while (0); if (dflag_mem == dflag_betapoint && 0) do { printf("\33[1;34m[%s:%d,%s] " "Reading vaddr %lx" "\33[0m\n", "src/memory/vaddr.c", 133, __func__, addr); ; } while (0); if (dflag_mem == dflag_exit && 0) do { printf("\33[1;34m[%s:%d,%s] " "Reading vaddr %lx" "\33[0m\n", "src/memory/vaddr.c", 133, __func__, addr); ; } while (0); if (dflag_mem == dflag_memprof && 0) do { printf("\33[1;34m[%s:%d,%s] " "Reading vaddr %lx" "\33[0m\n", "src/memory/vaddr.c", 133, __func__, addr); ; } while (0); if (dflag_mem == dflag_ctrlprof && 0) do { printf("\33[1;34m[%s:%d,%s] " "Reading vaddr %lx" "\33[0m\n", "src/memory/vaddr.c", 133, __func__, addr); ; } while (0); if (dflag_mem == dflag_simpoint && 0) do { printf("\33[1;34m[%s:%d,%s] " "Reading vaddr %lx" "\33[0m\n", "src/memory/vaddr.c", 133, __func__, addr); ; } while (0); } while (0);
...
void vaddr_write(struct Decode *s, vaddr_t addr, int len, word_t data, int mmu_mode) {
  ...
  if (__builtin_expect(mmu_mode == MMU_DYNAMIC, 0)) mmu_mode = isa_mmu_check(addr, len, MEM_TYPE_WRITE);
  if (mmu_mode == MMU_DIRECT) {
...
word_t vaddr_read_safe(vaddr_t addr, int len) {
  ...
  return vaddr_read_internal(
# 160 "src/memory/vaddr.c" 3 4
                            ((void *)0)
# 160 "src/memory/vaddr.c"
                                , addr, len, MEM_TYPE_READ, MMU_DYNAMIC);
}

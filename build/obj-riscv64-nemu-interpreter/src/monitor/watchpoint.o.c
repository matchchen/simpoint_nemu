...
# 4 "src/monitor/watchpoint.c" 2





# 8 "src/monitor/watchpoint.c"
...
static WP *head = 
# 21 "src/monitor/watchpoint.c" 3 4
                 ((void *)0)
# 21 "src/monitor/watchpoint.c"
                     , *free_ = 
# 21 "src/monitor/watchpoint.c" 3 4
                                ((void *)0)
# 21 "src/monitor/watchpoint.c"
...
void init_wp_pool() {
  ...
  wp_pool[32 - 1].next = 
# 29 "src/monitor/watchpoint.c" 3 4
                           ((void *)0)
# 29 "src/monitor/watchpoint.c"
                               ;

  head = 
# 31 "src/monitor/watchpoint.c" 3 4
        ((void *)0)
# 31 "src/monitor/watchpoint.c"
            ;
  free_ = wp_pool;
}
...
# 39 "src/monitor/watchpoint.c" 3 4
 ((void) sizeof ((
# 39 "src/monitor/watchpoint.c"
 free_ != 
# 39 "src/monitor/watchpoint.c" 3 4
...
# 39 "src/monitor/watchpoint.c"
 "free_ != NULL"
# 39 "src/monitor/watchpoint.c" 3 4
 , "src/monitor/watchpoint.c", 39, __extension__ __PRETTY_FUNCTION__); }))
# 39 "src/monitor/watchpoint.c"
                      ;
  WP *p = free_;
  free_ = free_->next;
...
# 46 "src/monitor/watchpoint.c" 3 4
 ((void) sizeof ((
# 46 "src/monitor/watchpoint.c"
 p >= wp_pool && p < wp_pool + 32
# 46 "src/monitor/watchpoint.c" 3 4
...
# 46 "src/monitor/watchpoint.c"
 "p >= wp_pool && p < wp_pool + NR_WP"
# 46 "src/monitor/watchpoint.c" 3 4
 , "src/monitor/watchpoint.c", 46, __extension__ __PRETTY_FUNCTION__); }))
# 46 "src/monitor/watchpoint.c"
                                            ;
  free(p->expr);
  p->next = free_;
...
# 53 "src/monitor/watchpoint.c" 3 4
 _Bool 
# 53 "src/monitor/watchpoint.c"
      success;
...
# 67 "src/monitor/watchpoint.c" 3 4
_Bool 
# 67 "src/monitor/watchpoint.c"
    delete_watchpoint(int NO) {
  WP *p, *prev = 
# 68 "src/monitor/watchpoint.c" 3 4
                ((void *)0)
# 68 "src/monitor/watchpoint.c"
                    ;
  for (p = head; p != 
# 69 "src/monitor/watchpoint.c" 3 4
                     ((void *)0)
# 69 "src/monitor/watchpoint.c"
                         ; prev = p, p = p->next) {
    if (p->NO == NO) { break; }
  }

  if (p == 
# 73 "src/monitor/watchpoint.c" 3 4
          ((void *)0)
# 73 "src/monitor/watchpoint.c"
              ) { return 
# 73 "src/monitor/watchpoint.c" 3 4
                         0
# 73 "src/monitor/watchpoint.c"
                              ; }
  if (prev == 
# 74 "src/monitor/watchpoint.c" 3 4
             ((void *)0)
# 74 "src/monitor/watchpoint.c"
                 ) { head = p->next; }
  else { prev->next = p->next; }

  free_WP(p);
  return 
# 78 "src/monitor/watchpoint.c" 3 4
        1
# 78 "src/monitor/watchpoint.c"
            ;
}

void list_watchpoint() {
  if (head == 
# 82 "src/monitor/watchpoint.c" 3 4
             ((void *)0)
# 82 "src/monitor/watchpoint.c"
                 ) {
  ...
  WP *p;
  for (p = head; p != 
# 89 "src/monitor/watchpoint.c" 3 4
                     ((void *)0)
# 89 "src/monitor/watchpoint.c"
                         ; p = p->next) {
...
void scan_watchpoint(vaddr_t pc) {
  WP *p;
  for (p = head; p != 
# 96 "src/monitor/watchpoint.c" 3 4
                     ((void *)0)
# 96 "src/monitor/watchpoint.c"
                         ; p = p->next) {
    
# 97 "src/monitor/watchpoint.c" 3 4
   _Bool 
# 97 "src/monitor/watchpoint.c"
        success;

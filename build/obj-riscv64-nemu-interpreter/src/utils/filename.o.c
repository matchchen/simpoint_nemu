...
# 2 "src/utils/filename.c" 2

_Bool 
# 3 "src/utils/filename.c"
    is_gz_file(const char *filename) {
  if (filename == 
# 4 "src/utils/filename.c" 3 4
                 ((void *)0) 
# 4 "src/utils/filename.c"
                      || strlen(filename) < 3) {
    return 
# 5 "src/utils/filename.c" 3 4
          0
# 5 "src/utils/filename.c"
               ;
  }
